...
public class Cube implements Icube{
    ...
    public void top_move_right(){
        if((x==FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //TRB
            ...
            z=-z; //ok
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //TCF
            x=FAR_PLACEMENT;
            z=ZERO;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==NEAR_PLACEMENT)){ //TCMF
            x=NEAR_PLACEMENT;
            z=ZERO;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==-NEAR_PLACEMENT)){ //TCMB
            x=-NEAR_PLACEMENT;
            z=ZERO;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //TCB
            x=-FAR_PLACEMENT;
            z=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TLC
            x=ZERO;
            z=FAR_PLACEMENT;
        }else if((x==-NEAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TMLC
            x=ZERO;
            z=NEAR_PLACEMENT;
        }else if((x==NEAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TMRC
            x=ZERO;
            z=-NEAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TRC
            x=ZERO;
            z=-FAR_PLACEMENT;
        }
    ...
    public void MT_move_right(){
        if((x==FAR_PLACEMENT)&&(y==NEAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //MTRB
            ...
            x=-NEAR_PLACEMENT; //ok
            z=-FAR_PLACEMENT; //ok
        }else if((x==ZERO)&&(y==NEAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //MTCF
            x=FAR_PLACEMENT;
            z=ZERO;
        }else if((x==ZERO)&&(y==NEAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //MTCB
            x=-FAR_PLACEMENT;
            z=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==NEAR_PLACEMENT)&&(z==ZERO)){ //MTLC
            x=ZERO;
            z=FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==NEAR_PLACEMENT)&&(z==ZERO)){ //TRC
            x=ZERO;
            z=-FAR_PLACEMENT;
        }
    ...
    public void MD_move_right(){
        if((x==FAR_PLACEMENT)&&(y==-NEAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //MDRB
            ...
            x=-NEAR_PLACEMENT; //ok
            z=-FAR_PLACEMENT; //ok
        }else if((x==ZERO)&&(y==-NEAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //MDCF
            x=FAR_PLACEMENT;
            z=ZERO;
        }else if((x==ZERO)&&(y==-NEAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //MDCB
            x=-FAR_PLACEMENT;
            z=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==-NEAR_PLACEMENT)&&(z==ZERO)){ //MDLC
            x=ZERO;
            z=FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==-NEAR_PLACEMENT)&&(z==ZERO)){ //MDRC
            x=ZERO;
            z=-FAR_PLACEMENT;
        }
    ...
    public void middle_move_left(){
        if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //CRB
            z=-z;//ok
        }else if((x==NEAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //CMRB
            x=FAR_PLACEMENT; //ok
            z=NEAR_PLACEMENT; //ok
        }else if((x==-NEAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //CMLB
            x=FAR_PLACEMENT; //ok
            z=-NEAR_PLACEMENT; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //CLB
            x=-x; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==-NEAR_PLACEMENT)){ //CLMB
            x=NEAR_PLACEMENT; //ok
            z=-FAR_PLACEMENT; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==NEAR_PLACEMENT)){ //CLMF
            x=-NEAR_PLACEMENT; //ok
            z=-FAR_PLACEMENT; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CLF
            z=-z; //ok
        }else if((x==-NEAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CMLF
            x=-FAR_PLACEMENT; //ok
            z=-NEAR_PLACEMENT; //ok
        }else if((x==NEAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CMRF
            x=-FAR_PLACEMENT; //ok
            z=NEAR_PLACEMENT; //ok
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CRF
            x=-x; //ok
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==NEAR_PLACEMENT)){ //CRMF
            x=-NEAR_PLACEMENT; //ok
            z=FAR_PLACEMENT; //ok
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==-NEAR_PLACEMENT)){ //CRMB
            x=NEAR_PLACEMENT; //ok
            z=FAR_PLACEMENT; //ok
        }else if((x==ZERO)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CCF
            x=-FAR_PLACEMENT;
            z=ZERO;
        }else if((x==ZERO)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //CCB
            x=FAR_PLACEMENT;
            z=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==ZERO)){ //CLC
            x=ZERO;
            z=-FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==ZERO)){ //CRC
            x=ZERO;
            z=FAR_PLACEMENT;
        }
    ...
    public void middle_move_right(){
        if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //MTRB
            x=-x; //ok
        }else if((x==NEAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //MTMRB
            x=-FAR_PLACEMENT; //ok
            z=-NEAR_PLACEMENT; //ok
        }else if((x==-NEAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //MTMLB
            x=-FAR_PLACEMENT; //ok
            z=NEAR_PLACEMENT; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //MTLB
            z=-z; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==-NEAR_PLACEMENT)){ //MTLMB
            x=-NEAR_PLACEMENT; //ok
            z=FAR_PLACEMENT; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==NEAR_PLACEMENT)){ //MTLMF
            x=NEAR_PLACEMENT; //ok
            z=FAR_PLACEMENT; //ok
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //MTLF
            x=-x; //ok
        }else if((x==-NEAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //MTMLF
            x=FAR_PLACEMENT; //ok
            z=NEAR_PLACEMENT; //ok
        }else if((x==NEAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //MTMRF
            x=FAR_PLACEMENT; //ok
            z=-NEAR_PLACEMENT; //ok
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //MTRF
            z=-z; //ok
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==NEAR_PLACEMENT)){ //MTRMF
            x=NEAR_PLACEMENT; //ok
            z=-FAR_PLACEMENT; //ok
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==-NEAR_PLACEMENT)){ //MTRMB
            x=-NEAR_PLACEMENT; //ok
            z=-FAR_PLACEMENT; //ok
        }else if((x==ZERO)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CCF
            x=FAR_PLACEMENT;
    ...
    public void left_move_down(){
        if((x==-FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //TLF
            ...
            y=ZERO;
            z=-NEAR_PLACEMENT;
        }else if((x==-FAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DLC
            y=ZERO;
            z=-FAR_PLACEMENT;
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CLF
            y=-FAR_PLACEMENT;
    ...
    public void ML_move_down(){
        if((x==-NEAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //TLF
            ...
            y=ZERO;
            z=FAR_PLACEMENT;
        }else if((x==-NEAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DMLC
            y=ZERO;
            z=-FAR_PLACEMENT;
        }else if((x==-NEAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CMLF
            y=-FAR_PLACEMENT;
    ...
    public void middle_move_down(){
        if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //TLF
            y=-y;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==NEAR_PLACEMENT)){ //TLMF
            y=-NEAR_PLACEMENT;
            z=FAR_PLACEMENT;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==-NEAR_PLACEMENT)){ //TLMB
            y=NEAR_PLACEMENT;
            z=FAR_PLACEMENT;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //TLB
            z=-z;
        }else if((x==ZERO)&&(y==NEAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //MTLB
            y=FAR_PLACEMENT;
            z=NEAR_PLACEMENT;
        }else if((x==ZERO)&&(y==-NEAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //MDLB
            y=FAR_PLACEMENT;
            z=-NEAR_PLACEMENT;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==-FAR_PLACEMENT)){ //DLB
            y=-y;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==-NEAR_PLACEMENT)){ //DLMB
            y=NEAR_PLACEMENT;
            z=-FAR_PLACEMENT;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==NEAR_PLACEMENT)){ //DLMF
            y=-NEAR_PLACEMENT;
            z=-FAR_PLACEMENT;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //DLF
            z=-z;
        }else if((x==ZERO)&&(y==-NEAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //MDLF
            y=-FAR_PLACEMENT;
            z=-NEAR_PLACEMENT;
        }else if((x==ZERO)&&(y==NEAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //MTLF
            y=-FAR_PLACEMENT;
            z=NEAR_PLACEMENT;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TCC
            y=ZERO;
            z=FAR_PLACEMENT;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DCC
            y=ZERO;
            z=-FAR_PLACEMENT;
        }else if((x==ZERO)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CCF
            y=-FAR_PLACEMENT;
    ...
    public void right_move_down(){
        if((x==FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //TLF
            ...
            y=ZERO;
            z=FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==NEAR_PLACEMENT)&&(z==ZERO)){ //MTRC
            y=ZERO;
            z=NEAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==-NEAR_PLACEMENT)&&(z==ZERO)){ //MDRC
            y=ZERO;
            z=-NEAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DRC
            y=ZERO;
            z=-FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CRF
            y=-FAR_PLACEMENT;
            ...
            y=NEAR_PLACEMENT;
            z=ZERO;
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==-FAR_PLACEMENT)){ //CRB
            y=FAR_PLACEMENT;
            z=ZERO;
        }
    ...
    public void front_face_cw(){
        if((x==FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //TRF
            ...
            x=-NEAR_PLACEMENT;
            y=ZERO;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==FAR_PLACEMENT)){ //DCF
            x=-FAR_PLACEMENT;
            y=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==FAR_PLACEMENT)){ //CLF
            x=ZERO;
    ...
    public void MF_face_cw(){
        if((x==FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==NEAR_PLACEMENT)){ //TRF
            ...
            x=FAR_PLACEMENT;
            y=-NEAR_PLACEMENT;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==NEAR_PLACEMENT)){ //TCF
            x=FAR_PLACEMENT;
            y=ZERO;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==NEAR_PLACEMENT)){ //DCF
            x=-FAR_PLACEMENT;
            y=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==NEAR_PLACEMENT)){ //CLF
            x=ZERO;
            y=FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==NEAR_PLACEMENT)){ //CRF
            x=ZERO;
            y=-FAR_PLACEMENT;
        }
    ...
    public void middle_face_cw(){
        if((x==FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TRF
            y=-y;
        }else if((x==FAR_PLACEMENT)&&(y==NEAR_PLACEMENT)&&(z==ZERO)){ //MTRF
            x=NEAR_PLACEMENT;
            y=-FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==-NEAR_PLACEMENT)&&(z==ZERO)){ //MDRF
            x=-NEAR_PLACEMENT;
            y=-FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DRF
            x=-x;
        }else if((x==NEAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DMRF
            x=-FAR_PLACEMENT;
            y=-NEAR_PLACEMENT; 
        }else if((x==-NEAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DMLF
            x=-FAR_PLACEMENT;
            y=NEAR_PLACEMENT; 
        }else if((x==-FAR_PLACEMENT)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DLF
            y=-y;
        }else if((x==-FAR_PLACEMENT)&&(y==-NEAR_PLACEMENT)&&(z==ZERO)){ //MDLF
            x=-NEAR_PLACEMENT;
            y=FAR_PLACEMENT;
        }else if((x==-FAR_PLACEMENT)&&(y==NEAR_PLACEMENT)&&(z==ZERO)){ //MTLF
            x=NEAR_PLACEMENT;
            y=FAR_PLACEMENT;
        }else if((x==-FAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TLF
            x=-x;
        }else if((x==-NEAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TMLF
            x=FAR_PLACEMENT;
            y=NEAR_PLACEMENT;
        }else if((x==NEAR_PLACEMENT)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TMRF
            x=FAR_PLACEMENT;
            y=-NEAR_PLACEMENT;
        }else if((x==ZERO)&&(y==FAR_PLACEMENT)&&(z==ZERO)){ //TCF
            x=FAR_PLACEMENT;
            y=ZERO;
        }else if((x==ZERO)&&(y==-FAR_PLACEMENT)&&(z==ZERO)){ //DCF
            x=-FAR_PLACEMENT;
            y=ZERO;
        }else if((x==-FAR_PLACEMENT)&&(y==ZERO)&&(z==ZERO)){ //CLF
            x=ZERO;
            y=FAR_PLACEMENT;
        }else if((x==FAR_PLACEMENT)&&(y==ZERO)&&(z==ZERO)){ //CRF
            x=ZERO;
            y=-FAR_PLACEMENT;
        }
