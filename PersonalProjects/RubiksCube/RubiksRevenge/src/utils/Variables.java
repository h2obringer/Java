...
public class Variables {
    ...
    public static final int POSSIBLE_MOVES = 16; //# of cubes to manipulate during a move animation/move
    
    public static final float NEAR_PLACEMENT = 1.05f; //placement of cubes away from the origin
    public static final float FAR_PLACEMENT = 3.15f; 
    ...
    public static final int ID_MTMLMF = 22; //MARK FOR REMOVAL
    public static final int ID_MTMRMF = 23; //MARK FOR REMOVAL
    ...
    public static final int ID_MTMLMB = 26; //MARK FOR REMOVAL
    public static final int ID_MTMRMB = 27; //MARK FOR REMOVAL
    ...
    public static final int ID_MDMLMF = 38; //MARK FOR REMOVAL
    public static final int ID_MDMRMF = 39; //MARK FOR REMOVAL
    ...
    public static final int ID_MDMLMB = 42; //MARK FOR REMOVAL
    public static final int ID_MDMRMB = 43; //MARK FOR REMOVAL
    ...
    public static final int MOVE_MBMR = 2; //middle-bottom move right
    public static final int MOVE_BMR = 3; //bottom move right
    public static final int MOVE_LMU = 4; //left move up
    public static final int MOVE_MLMU = 5; //middle-left vertical move up
    public static final int MOVE_MRMU = 6; //middle-right vertical move up
    public static final int MOVE_RMU = 7; //right move up
    public static final int MOVE_TML = 8; //top move right
    public static final int MOVE_MTML = 9; //middle-top move left
    public static final int MOVE_MBML = 10; //middle-bottom move left
    public static final int MOVE_BML = 11; //bottom move left
    public static final int MOVE_LMD = 12; //left move up
    public static final int MOVE_MLMD = 13; //middle-left vertical move up
    public static final int MOVE_MRMD= 14; //middle-right vertical move up
    public static final int MOVE_RMD = 15; //right move up
    public static final int MOVE_FCCW = 16; //front counter-clockwise
    public static final int MOVE_MFCCW = 17; //middle-front counter-clockwise
    public static final int MOVE_MBCCW = 18; //middle-back counter-clockwise
    public static final int MOVE_BCCW = 19; //back counter-clockwise
    public static final int MOVE_FCW = 20; //front clockwise
    public static final int MOVE_MFCW = 21; //middle-front clockwise
    public static final int MOVE_MBCW = 22; //middle-back clockwise
    public static final int MOVE_BCW = 23; //back clockwise
